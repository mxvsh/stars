...
*Total: 536 repositories across 34 languages*
...
- [r4j0x00/funcryptor](https://github.com/r4j0x00/funcryptor) - Encrypt C functions
...
- [mxvsh/log-broadcast](https://github.com/mxvsh/log-broadcast) - Broadcast your console's logs.
...
- [mxvsh/strapi-provider](https://github.com/mxvsh/strapi-provider)
- [htr-tech/zphisher](https://github.com/htr-tech/zphisher) - An automated phishing tool with 30+ templates. This Tool is made for educational purpose only ! Author will not be responsible for any misuse of this toolkit !
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) - A list of SaaS, PaaS and IaaS offerings that have free tiers of interest to devops and infradev
- [ionbot/ionbot.github.io](https://github.com/ionbot/ionbot.github.io) - Ion official website source code
...
- [mxvsh/modern-portfolio](https://github.com/mxvsh/modern-portfolio) - Personal portfolio website built with Next.js + Chakra UI
...
- [NeoHBz/hyathi_interview](https://github.com/NeoHBz/hyathi_interview)
...
- [mxvsh/renpm](https://github.com/mxvsh/renpm) - remote npm script execution
- [wissalHaji/DappTuto](https://github.com/wissalHaji/DappTuto) - A simple dapp example to illustrate the process of building a decentralized application
- [patriksimek/vm2](https://github.com/patriksimek/vm2) - Advanced vm/sandbox for Node.js
- [mxvsh/portfolio-react](https://github.com/mxvsh/portfolio-react) - Minimal and clean portfolio web design using React with dark mode.
...
- [mxvsh/filestream](https://github.com/mxvsh/filestream) - Telegram Bot to Stream File via Link
- [copy/v86](https://github.com/copy/v86) - x86 PC emulator and x86-to-wasm JIT, running in the browser
- [meteor/meteor](https://github.com/meteor/meteor) - Meteor, the JavaScript App Platform
- [webpack/webpack](https://github.com/webpack/webpack) - A bundler for javascript and friends. Packs many modules into a few bundled assets. Code Splitting allows for loading parts of the application on demand. Through "loaders", modules can be CommonJs, AMD, ES6 modules, CSS, Images, JSON, Coffeescript, LESS, ... and your custom stuff.
- [strapi/documentation](https://github.com/strapi/documentation) - Strapi Documentation
...
- [Synckage/synckage](https://github.com/Synckage/synckage) - Web based Node.js project manager
- [mxvsh/floxum](https://github.com/mxvsh/floxum) - Floxum adds realtime support to Strapi applications
- [spicetify/cli](https://github.com/spicetify/cli) - Command-line tool to customize Spotify client. Supports Windows, MacOS, and Linux.
- [thomas4019/expressa](https://github.com/thomas4019/expressa) - API creation middleware with an admin interface
...
- [ionbot/ion-app](https://github.com/ionbot/ion-app) - Web based Telegram user bot manager with custom commands, plugins and more.
- [keymetrics/pm2-auto-pull](https://github.com/keymetrics/pm2-auto-pull) - This app will automatically pull all applications managed by PM2 to the latest version (compatible git)
- [xensprojects/ip-addr-bot](https://github.com/xensprojects/ip-addr-bot) - Telegram bot that replies with the information of the IP address
- [mxvsh/modern-crypto-dashboard-ui](https://github.com/mxvsh/modern-crypto-dashboard-ui) - Modern Cryptocurrency Dashboard UI using React JS (Inspired by a Dribbble design)
- [mxvsh/todox-client](https://github.com/mxvsh/todox-client) - Advanced and Modern Todo application with user based todo lists.
- [mxvsh/amazon-tracker](https://github.com/mxvsh/amazon-tracker) - Node.js program to track product price on Amazon.
- [quran/audio.quran.com](https://github.com/quran/audio.quran.com) - quranicaudio.com
...
- [soumyadityac/youtube-viewer](https://github.com/soumyadityac/youtube-viewer) - 🤖 A view bot for Youtube.
- [arcrepo/arc-admin](https://github.com/arcrepo/arc-admin) - Admin dashboard for Arc, built with ReactJS.
...
- [ran-j/ChatBotNodeJS](https://github.com/ran-j/ChatBotNodeJS) - A deep learning ChatoBot build with nodejs and tensorflowjs
...
- [Kamahl19/react-native-wallet](https://github.com/Kamahl19/react-native-wallet) - Simple mobile Bitcoin & Ethereum wallet. For educational and experimental purposes.
- [webhooksite/webhook.site](https://github.com/webhooksite/webhook.site) - ⚓️ Easily test HTTP webhooks with this handy tool that displays requests instantly.
- [Rattlyy/NodeUserBot](https://github.com/Rattlyy/NodeUserBot) - Example Node.js UserBot made with NodeTGUserBot
...
- [mxvsh/airgram](https://github.com/mxvsh/airgram) - Modern Telegram client framework for TypeScript/JavaScript (Node.js).
- [NullDev/RNN.js](https://github.com/NullDev/RNN.js) - :pager: A very simple Recurrent Neural Network implementation
...
- [botmate/docs](https://github.com/botmate/docs) - documentation website for botmate
...
- [quran/quran.com-api](https://github.com/quran/quran.com-api) - Quran.com content APIs
- [quran/quran.com-frontend-v2](https://github.com/quran/quran.com-frontend-v2)
...
- [urania-dev/snapp](https://github.com/urania-dev/snapp) - Yet Another Url Shortner. A simple excercise to learn Svelte.
...
- [mxvsh/drivegram](https://github.com/mxvsh/drivegram) - ☁️ Personal cloud storage application that uses Telegram for storing files.
- [CopilotKit/CopilotKit](https://github.com/CopilotKit/CopilotKit) - React UI + elegant infrastructure for AI Copilots, AI chatbots, and in-app AI agents. The Agentic last-mile 🪁
- [mxvsh/modzero](https://github.com/mxvsh/modzero) - ⚒️ Telegram moderation platform with beautifully crafted dashboard. Quick setup with Vercel.
...
- [adeyahya/prisma-typebox-generator](https://github.com/adeyahya/prisma-typebox-generator) - typebox ( typescript static type & json schema ) generator for Prisma 2
- [snazzybot/snazzybot](https://github.com/snazzybot/snazzybot) - Elevate Your Telegram Experience with Sanzzy.
- [saas-js/saas-ui-nextjs-landing-page](https://github.com/saas-js/saas-ui-nextjs-landing-page) - A free Next.js landing page template built with Chakra UI
...
- [mxvsh/monawwar.io](https://github.com/mxvsh/monawwar.io)
...
- [kimjbstar/prisma-class-generator](https://github.com/kimjbstar/prisma-class-generator) - Class generator from Prisma schema.
...
- [mxvsh/portfolio](https://github.com/mxvsh/portfolio) - yet another portfolio website, built with next.js and chakra-ui ❤️
- [IanDxSSXX/ReNest](https://github.com/IanDxSSXX/ReNest) - Let SwiftUI nests in React.
...
- [mxvsh/product-invoice](https://github.com/mxvsh/product-invoice) - Add products and generate invoices.
...
- [mxvsh/toprepo](https://github.com/mxvsh/toprepo) - Explore GitHub repositories
...
- [balena-io/pinejs](https://github.com/balena-io/pinejs) - Generate rest APIs from natural language models
...
- [envplat/envplat](https://github.com/envplat/envplat) - Self-hosted environment variable management platform
...
- [mxvsh/vscode-copydock](https://github.com/mxvsh/vscode-copydock) - VS Code Extension that helps you send your copied code or text directly to your friend's editor in no time.
...
- [mxvsh/remac](https://github.com/mxvsh/remac) - remote action
...
- [ionbot/ionbot-old](https://github.com/ionbot/ionbot-old) - Yet another modular Telegram user bot.
- [mxvsh/wordblock](https://github.com/mxvsh/wordblock) - Create and manage posts for Telegram
...
- [CGMTG/cgm-tg](https://github.com/CGMTG/cgm-tg)
...
- [rojvv/ssg](https://github.com/rojvv/ssg) - Generate GramJS/Telethon string sessions in your browser.
- [mxvsh/realsync](https://github.com/mxvsh/realsync) - Execute server functions from client and realtime synchronisation module for modern applications. 
- [alephjs/aleph.js](https://github.com/alephjs/aleph.js) - The Full-stack Framework in Deno.
- [streamich/react-use](https://github.com/streamich/react-use) - React Hooks — 👍
- [colinhacks/zod](https://github.com/colinhacks/zod) - TypeScript-first schema validation with static type inference
- [altangent/ccxws](https://github.com/altangent/ccxws) - WebSocket client for 38 cryptocurrency exchanges
- [discordjs/discord.js](https://github.com/discordjs/discord.js) - A powerful JavaScript library for interacting with the Discord API
- [mxvsh/snazzybot](https://github.com/mxvsh/snazzybot) - Get results across web right on Telegram
...
- [mxvsh/typescript-boilerplate](https://github.com/mxvsh/typescript-boilerplate) - Minimal Typescript Boilerplate. No additional dependencies.
...
- [kkfor/for-editor](https://github.com/kkfor/for-editor) - for-editor - A markdown editor based on React
...
- [mxvsh/shelljsbot](https://github.com/mxvsh/shelljsbot) - 💎 Execute shell commands on your server using telegram 
...
- [NeoHBz/google-photos-exif](https://github.com/NeoHBz/google-photos-exif) - A tool to populate missing `DateTimeOriginal` EXIF metadata in Google Photos takeout, using Google's JSON metadata.
- [NeoHBz/react-stripe-menu](https://github.com/NeoHBz/react-stripe-menu) - A clone of Stripe's animated menu using React, Styled Components and React-Flip-Toolkit
- [mxvsh/nextjs-cli-app-template](https://github.com/mxvsh/nextjs-cli-app-template) - Build command line interface applications using Next js
...
- [mxvsh/vscode-chakraui-snippets](https://github.com/mxvsh/vscode-chakraui-snippets) - Snippets for Chakra UI React
- [mxvsh/omatsuri](https://github.com/mxvsh/omatsuri) - PWA with 12 open source frontend focused tools
...
- [mxvsh/search4](https://github.com/mxvsh/search4) - 💎 Search for a user across social networking websites.
